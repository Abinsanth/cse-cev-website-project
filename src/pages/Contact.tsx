  ...
  return (
    <main className="pt-24 pb-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 rounded-lg shadow-md p-8 h-full">
              <h2 className="text-2xl font-bold mb-6 text-cse">Get in Touch</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 495 2287246 (Department)</p>
                    <p className="text-gray-600">+91 495 2287250 (Office)</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  <Clock className="w-6 h-6 text-cse-accent mr-4 flex-shrink-0" />
                  <div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a 
                    ...
                    className="w-10 h-10 bg-cse rounded-full flex items-center justify-center hover:bg-cse-accent transition-colors"
                  >
        ...
        {/* Map Section */}
        <div className="mt-16">
          <h2 className="text-2xl font-bold mb-6 text-cse">Find Us</h2>
          <div className="rounded-lg overflow-hidden shadow-md h-96 border border-gray-200">
            <iframe
